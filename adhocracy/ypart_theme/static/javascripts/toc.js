...
/* - toc.js - */
// https://ypart-cms.liqd.net/portal_javascripts/toc.js?original=1
jQuery(function($){var dest,content,location,stack,oltoc,numdigits,wlh,target,targetOffset;dest=$('dl.toc dd.portletItem');content=$('#content-core');if(!content||!dest.length){return}
